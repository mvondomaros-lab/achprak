...
def main():
    ...
    text = [
        ...
        "- GFN1-xTB and GFN2-xTB give different parent geometries and cis/trans energy ordering. "
        ...
        "Lengths use ångströms (Å). A force threshold in eV/Å controls when geometry optimization stops. "
        "A seed fixes the random numbers used to generate a reproducible starting geometry. "
        ...
        "The initial three-dimensional geometry is generated by RDKit's ETKDGv3 method with seed 42 unless stated. "
    ...
    text += [
        ...
        "",
        "MAXCI limits the configurations used to represent excited states; WRTCI controls how many states are printed. Shifts are MAXCI=800 minus MAXCI=2000 at the same tight geometry. Positive energy shifts mean shorter wavelengths. "
    ...
    text += [
        ...
        "Both columns below use INDO/S–CIS with MAXCI=800, changing only the optimized geometry. A peak at exactly 5.5000 eV lies on the plotted boundary and does not establish a resolved maximum beyond it.",
        "",
    ...
    if (root / "planarity.json").exists():
        text += [
            ...
            "The C–N=N–C torsion alone does not measure phenyl-ring planarity. BFGS is an optimizer that estimates energy curvature from successive steps. Heavy-atom plane RMS is the root-mean-square distance of non-hydrogen atoms from their fitted plane. "
