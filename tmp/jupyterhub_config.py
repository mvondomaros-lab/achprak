...
#  Default: '/home/jupyterhub/venv/share/jupyterhub'
# c.JupyterHub.data_files_path = '/home/jupyterhub/venv/share/jupyterhub'
...
c.Authenticator.admin_users = {"supervisor"}
c.PAMAuthenticator.allowed_groups = {"common"}

c.JupyterHub.spawner_class = "localprocess"

c.Spawner.cmd = ["/home/jupyterhub/venv/bin/jupyterhub-singleuser"]
